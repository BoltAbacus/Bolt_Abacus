...
export const STUDENT_PROFILE_PAGE = '/student/profile';
...
export const STUDENT_ROADMAP = `${STUDENT_ROUTE}/roadmap`;
export const STUDENT_ARCHIVE = `${STUDENT_ROUTE}/archive`;
export const STUDENT_VIRTUAL_ABACUS = `${STUDENT_ROUTE}/virtual-abacus`;
export const STUDENT_LEADERBOARD = `${STUDENT_ROUTE}/leaderboard`;
...
export const STUDENT_PRACTICE_PROGRESS_UPDATE_ENDPOINT = '/updatePracticeProgress/';
export const STUDENT_PRACTICE_PROGRESS_GET_ENDPOINT = '/getPracticeProgress/';
