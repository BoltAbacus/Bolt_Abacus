    ...
    <div className={`text-white ${className}`}>
      ...
      <div className="grid grid-cols-4 gap-6">
        {shortcuts.map((shortcut) => (
          ...
          >
            <div className="bg-[#080808]/80 hover:bg-[#191919] backdrop-blur-xl p-6 rounded-2xl transition-all duration-500 group-hover:transform group-hover:scale-110 h-full border border-gold/40 ring-1 ring-white/5 group-hover:border-gold group-hover:shadow-[0_0_40px_rgba(255,186,8,0.25)] relative overflow-hidden">
              {/* Glow overlays */}
              ...
              <div className="flex flex-col items-center text-center space-y-4 relative z-10">
                <div className="w-20 h-20 rounded-2xl bg-[#080808]/80 border border-gold/40 ring-1 ring-white/5 flex items-center justify-center text-3xl shadow-xl group-hover:shadow-[0_0_30px_rgba(255,186,8,0.25)] transition-all duration-500 transform group-hover:rotate-12">
                  {shortcut.icon}
                </div>
                <div>
